...
class Index extends Component {
  ...
  onDisplay = () => (e) => {
    ...
    // 每日签到事件
    dispatch({ type: 'applicationAnalysis/createEventRecord', payload: { key: ApplicationAnalysisKey.ActionDailySign } });
  }
  ...
  renderButton = () => (
    <div onClick={this.onDisplay()}  style={{ height: '.5rem', lineHeight: '.5rem'}}>
      签到
    </div>
  )
